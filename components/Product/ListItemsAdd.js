...
function ListItemsAdd({ list, open, setSuggestion, setCurrentMaterial, materials, isAdd, setQuantity, setCurrentMaterialChanged }) {
    const Button = ({ openModal, material }) => {
        ...
        const tittle = isAdd ? "Abrir" : "Cambiar";
        return (
